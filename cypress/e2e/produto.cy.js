describe('Cadastro produto  ', () => {
    beforeEach(() => cy.visit('https://harv.buildbox.one/#/seller/create/product'))
        it.only('fills the from and submits it', () => {
            ...
            cy.visit('https://harv.buildbox.one/#/seller/create/product')
...
describe('redirecionamento para tela de listagem de produtos', () => {
    beforeEach(() => cy.visit('https://harv.buildbox.one/#/seller/create/product'))
        it.only('fills the from and submits it', () => {
            ...
            cy.get('input[name="price"]').as('price').type('15')
            cy.get('input[name="discount"]').as('discount').type('10')
            cy.get('input[name="start_Date"]').type('2023-08-07')
            cy.get('input[name="end_Date"]').invoke('removeAttr', 'disabled').type('2023-08-10')
           ...
           // cy.url('https://harv.buildbox.one/#/seller/create/product')
